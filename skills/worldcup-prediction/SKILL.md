...
- Keep the root `README.md` current when architecture changes. It should explain frontend, Supabase tables, import jobs, external sources, and model/strategy engineering with a Mermaid diagram.
