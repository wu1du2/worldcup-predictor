...
- Current production router candidates are the final3 set: `tem_hybrid_draw_poisson_v2_d1_n2`, `tem_draw_anchor_3_max5_5`, and `context_poisson_ev_v3`; `low_score_basket_4` remains the no-odds fallback, not a normal routed candidate.
