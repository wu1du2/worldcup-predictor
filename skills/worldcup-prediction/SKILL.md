...
- Current production router candidates must match the three flagship strategies shown in the frontend knockout strategy view: stable `tem_draw_anchor_capped_1_draw5_5_cap35`, value `tem_poisson_drawguard_context_v3_n2_draw7_5_cap35_p0_006`, and consensus `tem_consensus_poisson_context_v1_c1_n4_cap7`. `low_score_basket_4` remains the no-odds fallback, not a normal routed candidate. Dynamic leaderboard candidates are offline/lab material unless explicitly re-enabled.
