...
- Current production router candidates must match the three flagship strategies shown in the frontend knockout strategy view: stable `tem_draw_anchor_lean_homeaway2_draw5_5_cap25`, value `tem_poisson_drawguard_context_v3_n2_draw7_5_cap35_p0_006`, and consensus `tem_source_consensus_poisson_context_v1_s2_c3_n3_cap6`. `low_score_basket_4` remains the no-odds fallback, not a normal routed candidate. Dynamic leaderboard candidates are offline/lab material unless explicitly re-enabled.
