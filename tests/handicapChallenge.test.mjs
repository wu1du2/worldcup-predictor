...
test('calculateMaxPayoutOdds sums every selected combo ticket payout', () => {
  const matches = [
    { matchId: 'hc1', odds: { win: 2, draw: 3.05, loss: 2.51 } },
    { matchId: 'hc2', odds: { win: 2.58, draw: 3, loss: 2.3 } },
    { matchId: 'hc3', odds: { win: 1.88, draw: 5, loss: 3.22 } },
    { matchId: 'hc4', odds: { win: 7, draw: 3.1, loss: 2.11 } },
  ];
