...
test('candidate strategy set contains final3 production candidates and offline strategies', () => {
  ...
  const valueV5 = candidateStrategies.find((strategy) => strategy.id === 'tem_poisson_drawguard_context_v3_n2_draw7_5_cap35_p0_006');
...
test('runCandidateStrategyBacktests settles every candidate with consistent ROI accounting', () => {
  ...
  const valueV5 = results.find((result) => result.strategyId === 'tem_poisson_drawguard_context_v3_n2_draw7_5_cap35_p0_006');
