...
function getStrategyPickStandard(strategyId) {
  ...
  if (strategyId === 'tem_poisson_diverse_context_v1_n2_cap35_p0_006') {
    return '标准是用赛前泊松基础模型估进球，先看 EV 候选池，再优先选不同赛果方向的两个比分。';
  }
...
function describePickedScore({ strategyId, pick, scoreOptions }) {
  ...
  if (strategyId === 'context_poisson_ev_v2'
    ...
    || strategyId === 'tem_poisson_diverse_context_v1_n2_cap35_p0_006') {
...
function scoreStrategyFeatures({ strategy, odds, match = null }) {
  ...
  if (strategy.id === 'tem_poisson_diverse_context_v1_n2_cap35_p0_006') return market.hasCompleteScoreBoard ? 1.12 : 0.35;
